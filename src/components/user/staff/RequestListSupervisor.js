...
function RequestListSupervisor() {
    ...
    async function getRequests() {
        await axios.get("https://af-group-project.herokuapp.com/api/v1/requests/getRequestByStaffId/6291df9650646990e2ccbdc4")
        .then(res => res.data.map(info=>{
            axios.get(`https://af-group-project.herokuapp.com/api/v1/groups/get/${info.group}`)
            .then(res=>{
