...
function RegisterStudent() {
  ...
  const handleSubmit = (e) => {
    ...
    if (password === confirmPassword) {
      ...
      axios
        .post("https://af-group-project.herokuapp.com/api/v1/students/registerStudent", newStudent)
        .then((res) => {
          console.log(res);
      ...
      axios
        .post("https://af-group-project.herokuapp.com/api/v1/users/add/", newLogin)
        .then((res) => {
          console.log(res);
