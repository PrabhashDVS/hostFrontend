...
function ViewGroups() {
    ...
    const deleteGroup = async (id, idNumber) => {
        await axios
            .delete("https://af-group-project.herokuapp.com/api/v1/groups/delete/" + id)
            .then((res) => {
                console.log(res);
            });

        await axios
            .delete("https://af-group-project.herokuapp.com/api/v1/users/deleteByUserID/" + idNumber)
            .then((res) => {
                console.log(res);
            });
        loadGroup();
    ...
    const loadGroup = () => {
        axios
            .get("https://af-group-project.herokuapp.com/api/v1/groups/")
            .then((res) => {
                setGroups(res.data);
    ...
    useEffect(() => {
        async function getGroups() {
            const { data } = await axios.get("https://af-group-project.herokuapp.com/api/v1/groups");
