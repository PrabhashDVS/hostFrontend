...
function Header() {
    ...
    const handleMyClick = (e) => {
        ...
        if (user.role == "student") {
            axios
                .get("https://af-group-project.herokuapp.com/api/v1/students/getStudentUsingUserID/" + user.userID)
                .then((res) => {
        ...
        if (user.role == "supervisor") {
            axios
                .get("https://af-group-project.herokuapp.com/api/v1/staff/getStaffUsingUserID/" + user.userID)
                .then((res) => {
